return function(Window, Fluent)
    ...
    local success, err = pcall(function()
        ...
        local function passesFilter(model, prompt)
            ...
            -- 1. Lấy dữ liệu an toàn từ Fluent Options (Đồng bộ chuẩn 100% với Main & SaveManager)
            ...
            -- Nếu người dùng không chọn lọc bất kỳ điều kiện nào -> Nhặt hết mọi món
            if #activeSkills == 0 and #activeRarities == 0 and #activeStats == 0 then
                return true
            end

            -- 2. Đọc Attribute từ món đồ dựa theo ảnh Properties Studio
            ...
            -- 3. CƠ CHẾ 1: ƯU TIÊN LỌC SKILL (Có Skill chọn = Nhặt luôn)
            ...
            -- 4. CƠ CHẾ 2: LỌC RARITY (Phẩm cấp)
            ...
            -- 5. CƠ CHẾ 3: LỌC CHỈ SỐ & % TỐI THIỂU
        ...
        -- Vòng lặp quét đồ trong workspace.itemdrop
        task.spawn(function()
